...
<main class="flex flex-col items-center justify-center min-h-screen">
    <div class="h-screen flex flex-col justify-center items-center w-full">
        <div class="h-[70%] w-[80%] flex flex-col justify-center items-center text-white gap-3">
            ...
            <a href="/passes" class="mt-5 bg-black text-center rounded-md p-5 min-w-[20%] max-w-[20%] text-2xl font-semibold cursor-pointer hover:scale-105 transition-[scale] duration-200 ease-in-out">Book Tickets</a>
        </div>
    </div>

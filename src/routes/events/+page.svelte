        ...
        <div class="e-centre" in:fade={{ duration: 300, delay: 150 }}>
            ...
            <div class="flex flex-col justify-center">
                ...
                {:else}
                    ...
                    <div>
                        No Events So Far, ComeBack sometime Else
                    </div>
                {/if}
            {/if}
                                                        ...
                                                        <div class="absolute w-full hover:translate-z-13 inset-0 bg-black/20 opacity-0 group-hover:opacity-400 transition-all duration-200 ease-out rounded-xl backdrop-blur-sm backdrop-brightness-75">
                                                            <div class="absolute inset-0 p-6 flex flex-col justify-center">
                                                                ...
                                                                <div class="hidden md:block overflow-hidden">
                                                                    <p class="text-[#C7AE93]/95 text-sm mt-4 line-clamp-3 transform translate-y-8 group-hover:translate-y-0 transition-transform duration-300 delay-75 ease-out">
                                                                        {event.description}
                                                                    </p>
                                                                </div>
                                                                
                                                                <div class="overflow-hidden">
                                                                    <p class="text-[#C7AE93]/90 text-xs mt-4 transform translate-y-8 group-hover:translate-y-0 transition-transform duration-300 delay-100">
                        ...
                        >
                            ...
                            <div class="block md:hidden">
                                <CardContainer
                                        ...
                                        >
                                            <CardBody
                                                className="bg-gray-50 flex flex-col justify-between relative group/card  dark:shadow-2xl dark:shadow-[#C7AE93]/30  dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto  sm:w-[24rem] h-[37rem] rounded-xl p-6 border"
                                            >
                                                <CardItem
                                                    {isMouseEntered}
                                                    translateZ="100"

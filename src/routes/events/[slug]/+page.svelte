...
<div class="centre main">
    <CardContainer bind:isMouseEntered className={`inter-var my-16 fade-in ${isLoaded ? 'show' : ''}`}>
        <CardBody
        ...
        >
            <div class={`image-container w-full h-80 overflow-hidden rounded-xl ${isLoaded ? 'loaded' : ''}`}>
                <img
                            ...
                            >
                                {#if event.teamSize != null}
                                    <div class="flex items-center">
                                        ...
                                        <span>Team size: {event.teamSize} {event.teamSize === 1 ? "person" : "people"}</span>
                                    </div>
                                {:else}
...
.event-detail-item:nth-child(1) { animation-delay: 0.4s; }
.event-detail-item:nth-child(2) { animation-delay: 0.5s; }
.event-detail-item:nth-child(3) { animation-delay: 0.6s; }
